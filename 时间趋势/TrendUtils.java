...
public class TrendUtils {
    ...
    //key默认date,value默认为value,type默认小时，nums默认近12小时
    public static Map<String, List> recentTimeTrend(List<Map> maps){
        return recentTimeTrend(maps,12,"date","value","hour");
    }
    /**
     * 计算当前时间趋势图
     ...
     * @return
     */
    public static Map<String,List> currentTimeTrend(List<Map> maps,String key,String value,String type){
        int timeBegin = 0;
        int timeEnd = 23;
        int maxTime = 0;
        Map<String,List> result = new HashMap<>();
    ...
    public static Map<String,List> currentTimeTrend(List<Map> maps,String type){
        return currentTimeTrend(maps,"date","value",type);
    }
    //key默认date,value默认value,type默认hour
    public static Map<String,List> currentTimeTrend(List<Map> maps){
        return currentTimeTrend(maps,"date","value","hour");
    }
}
